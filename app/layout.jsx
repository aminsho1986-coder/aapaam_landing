...
export async function generateMetadata({ params }) {
  ...
  const PagesData = {
    "/":{
      ...
      description:
        "ارزیابی و جبران میزان انتشار کربن، پیوستن به مسیر نت زیرو و خرید و فروش اعتبار در بازار کربن",
    },
    "/about":{
      title:
        "آپام | درباره ما",
  ...
  const mainData = {
    ...
    twitter: {
      ...
      description: "ارزیابی و جبران میزان انتشار کربن، پیوستن به مسیر نت زیرو و خرید و فروش اعتبار در بازار کربن",
      creator: "آپام",
