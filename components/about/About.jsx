...
export default function About() {
  const [headerData] = useState([
    ...
    {
      title: "ماموریت",
      text: "آپام برای رسیدن به وضعیت پایداری کره ی زمین عمیقا تلاش میکند با استفاده از روش ها و تکنولوژی های جذب کربن بروز و دارای اثربخشی چند جانبه،بتواند اعتبار کربن با کیفیت را به صورت قابل اندازه گیری و قابل ردیابی برای پروژه های با ارزش زیستی-انسانی تولید و عرضه کند.",
    },
  ]);
