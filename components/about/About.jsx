...
export default function About() {
  const [headerData] = useState([
    {
      title: "تاثیرگذاری",
      text: "آپام، به عنوان یک پلتفرم ارائه‌دهنده ارزیابی کربن، سفر صفر کربن و تبادل کربن در راستای توانمندسازی کسب و کارها و افراد حقیقی که در جهت آینده پایدار گام برمی‌دارند نقش آفرینی می‌کند.",
    },
    {
      title: "چشم انداز",
      text: "آپام، با ساختاری چابک و مقیاس پذیر در مسیردستیابی به هدف کربن صفر پیشگام بوده؛ همچنین با ارائه طیف گسترده‌ای از خدمات کاربرد پسند، دورنمای هدایت بازار کربن پاک و انرژی سبز را در سر می‌پروراند که به سوی آینده‌ای که در آن پایداری و نوآوری به عنوان دو محور اساسی توسعه‌یافتگی؛ سوق می‌دهد."
    },
    {
      title: "ماموریت",
      text: "هدف ما بازگردانی تعادل به زمین(سیاره خود) از طریق پروژه‌های جذب نوآورانه و پایداری کربن دی اکسید است. این ابتکارات نه تنها انتشار کربن را کاهش می‎‌دهد، بلکه همه‌گان را به سمت داشتن زمین سالم‌تر و سرزنده‌تر سوق می‌دهد.",
    },
  ]);
  const [storyData] = useState([
    ...
    {
      title: "1400",
      text: "وارد شدن به پروژه های جبران کربن در حوزه MENA شوید",
    },
    {
      title: "1401",
      text: "همکاری با مشتریان تجاری بین المللی",
    },
    {
      title: "1402",
      text: "شروه توسعه وب سرویس آپام",
    },
  ]);
...
const AboutStory = ({ storyData }) => {
  return (
    <section className={`${styles.story} body-container`}>
      <span className={`${styles.sectionTitle} section-title`}> داستان ما </span>
