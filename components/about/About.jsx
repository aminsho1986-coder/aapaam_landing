...
export default function About() {
  const [headerData] = useState([
    {
      title: "تاثیرگذاری",
      text: "آپام، به عنوان یک پلتفرم ارائه‌دهنده ارزیابی کربن، سفر نت زیرو و تبادل کربن در راستای توانمندسازی کسب و کارها و افراد حقیقی که در جهت آینده پایدار گام برمی‌دارند نقش آفرینی می‌کند.",
    },
    {
      title: "چشم انداز",
      text: "آپام، با ساختاری چابک و مقیاس پذیر در مسیردستیابی به هدف نت زیرو پیشگام بوده؛ همچنین با ارائه طیف گسترده‌ای از خدمات کاربرد پسند، دورنمای هدایت بازار کربن پاک و انرژی سبز را در سر می‌پروراند که به سوی آینده‌ای که در آن پایداری و نوآوری به عنوان دو محور اساسی توسعه‌یافتگی؛ سوق می‌دهد."
    },
    {
      title: "ماموریت",
