...
export default function Company({ serverStatus, serverData }) {
  ...
  const [questionsData] = useState([
    {
      id: "1",
      title: "ردپای سالانه شما چطور محاسبه می‌شود؟",
      description:
        "محاسبه ردپای کربن سالانه یک شرکت شامل اندازه گیری و ارزیابی انتشار گازهای گلخانه ای (GHG) آن در مناطق مختلف عملیاتی است.",
